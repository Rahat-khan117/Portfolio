  ...
  return (
    <div className="flex flex-col lg:flex-row xl:gap-12 lg:gap-10 md:gap-7 sm:gap-4 gap-3">
      <div className="flex flex-col sm:flex-row gap-12">
        <div className="h-[300px] w-[190px] bg-linear-to-r from-[#c061e5] to-[#53176b] rounded-2xl flex justify-center items-center text-white">
          <div>
        ...
        <div>
          <div>
            <p className="xl:text-4xl lg:text-3xl md:text-3xl sm:text-3xl text-xl font-bold md:leading-[3.5rem]">
              Over <span className="text-[#d995f4]">Two years </span>of programming,<br /> I have developed <span className="text-[#d995f4]">lots of
              projects</span> <br /> using my Creativity and  <br /> programming
              knowledge
            </p>
            <button
              className="btn text-white w-fit mt-4 bg-linear-to-r from-[#c061e5] to-[#53176b] text-xl
